  ...
  public function execute($request)
  {
    ...
    if (QubitAcl::check($this->resource, 'update')) {
      ...
      $validatorSchema->type = new sfValidatorString([
        'required' => true, ], [
          'required' => $this->context->i18n->__('%1%Type%2% - This is a %3%mandatory%4% element.', ['%1%' => '<a href="http://ica-atom.org/doc/RS-4#Type_of_description">', '%2%' => '</a>', '%3%' => '<a href="http://ica-atom.org/doc/RS-4#Structure_and_use_4.7">', '%4%' => '</a>']), ]);
      $values['type'] = $this->resource->type;

      $validatorSchema->authorizedFormOfName = new sfValidatorString([
        'required' => true, ], [
          'required' => $this->context->i18n->__('%1%Authorized form of name%2% - This is a %3%mandatory%4% element.', ['%1%' => '<a href="http://ica-atom.org/doc/RS-4#Authorised_name">', '%2%' => '</a>', '%3%' => '<a href="http://ica-atom.org/doc/RS-4#Structure_and_use_4.7">', '%4%' => '</a>']), ]);
