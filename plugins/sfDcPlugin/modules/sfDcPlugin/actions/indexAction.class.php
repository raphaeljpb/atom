  ...
  public function execute($request)
  {
    ...
    if (QubitAcl::check($this->resource, 'update'))
    {
      ...
      $validatorSchema->identifier = new sfValidatorString([
        'required' => true], [
        'required' => $this->context->i18n->__('%1%Identifier%2% - This is a mandatory element.', ['%1%' => '<a href="http://dublincore.org/documents/dcmi-terms/#elements-identifier">', '%2%' => '</a>'])]);
      $values['identifier'] = $this->resource->identifier;

      $validatorSchema->title = new sfValidatorString([
        'required' => true], [
        'required' => $this->context->i18n->__('%1%Title%2% - This is a mandatory element.', ['%1%' => '<a href="http://dublincore.org/documents/dcmi-terms/#elements-title">', '%2%' => '</a>'])]);
