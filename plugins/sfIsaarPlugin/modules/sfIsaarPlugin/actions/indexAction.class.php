    ...
    if (QubitAcl::check($this->resource, 'update'))
    {
      ...
      $validatorSchema->descriptionIdentifier = new sfValidatorAnd([
        new sfValidatorString(
          ['required' => true],
          ['required' => $this->context->i18n->__('%1%Authority record identifier%2% - This is a %3%mandatory%4% element.', ['%1%' => '<a href="http://ica-atom.org/doc/RS-2#5.4.1">', '%2%' => '</a>', '%3%' => '<a href="http://ica-atom.org/doc/RS-2#4.7">', '%4%' => '</a>'])]
        ),
